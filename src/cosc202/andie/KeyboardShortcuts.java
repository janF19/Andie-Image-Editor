 ...
 * Linux based operating systems based on pre established common conventions
 * like
...
public class KeyboardShortcuts {
        ...
        // open shortcut
        public static KeyEvent openKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
        ...
        // save shortcut
        public static KeyEvent saveKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // save as shortcut
        public static KeyEvent saveAsKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // exit shortcut
        public static KeyEvent exitKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // export shortcut
        public static KeyEvent exportKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // undo shortcut
        public static KeyEvent undoKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // redo shortcut
        public static KeyEvent redoKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent rotateRightKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent rotateLeftKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent rotate180KeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent resizeKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent verticalFlipKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent horizontalFlipKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // zoom out shortcut
        public static KeyEvent zoomOuKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // zoom full shortcut
        public static KeyEvent zoomFullKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent engLanguagueKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent spanishLanguageKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
                        KeyEvent.ALT_DOWN_MASK | KeyEvent.SHIFT_DOWN_MASK, KeyEvent.VK_S, KeyEvent.CHAR_UNDEFINED);

        public static KeyStroke spanishLanguagueKeyStroke = KeyboardShortcuts
                        .getAltShiftKeyStroke(spanishLanguageKeyEvent);

        // mean filter shortcut
        public static KeyEvent meanKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // softblur shortcut
        public static KeyEvent softBlurKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // sharpen shortcut
        public static KeyEvent sharpenKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // median shortcut
        public static KeyEvent medianKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent gaussianKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // embos shortcut
        public static KeyEvent embosKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // sobel shortcut
        public static KeyEvent sobelKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent blockAverageKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent randomScatterKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // grey scale shortcut
        public static KeyEvent greyScaleKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
                        KeyEvent.CTRL_DOWN_MASK, KeyEvent.VK_G, KeyEvent.CHAR_UNDEFINED);
        ...
        public static KeyEvent colorChannelKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // invert shortcut
        public static KeyEvent invertKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent brightnessKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        public static KeyEvent recordKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // stop macro shortcut
        public static KeyEvent stopKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // load macro shortcut
        public static KeyEvent loadKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // warmth shortcut
        public static KeyEvent warmthKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        // vibrance shortcut
        public static KeyEvent vibranceKeyEvent = new KeyEvent(new JPanel(), KeyEvent.KEY_PRESSED,
                        System.currentTimeMillis(),
        ...
        /**
         * <p> 
         * A method that returns a keystroke instance that represents a keyboard shortcut with the 
         * Ctrl key on Windows and Linux and the command key on MacOS
         * </p> 
         * 
         * <p> 
         * This method checks the name of the operating system to determine whether their is the word 
         * "mac" within the name, and modifies the key accordingly. If this is the case it uses the 
         * command key for MacOS and if not it used the Ctrl key for Windows and Linux. 
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign
         * @return A keystroke instance of the given keyevent with the modifiers added
         */
         ...
         * 
         * <p> 
         * This method assigns a keystroke to the given keyevent 
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent 
         */
         ...
         * <p> 
         * A method that returns a keystroke instance that represents a keyboard shortcut with the 
         * Alt key on Windows and Linux and the Option key on MacOS 
         * </p> 
         * 
         * <p> 
         * This method checks the name of the operating system to determine whether their is the word 
         * "mac" within the name, and modifies the key accordingly. If this is the case it uses the 
         * option key for MacOS and if not it uses the Alt key for Windows and Linux 
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent with the modifies added 
         */
        ...
        /** 
         * <p> 
         * A method that returns a keystroke instance that represents a keyboard shortcut with
         * Ctrl-Alt on Windows and Linux and command-option on MacOS
         * </p> 
         * 
         * <p> 
         * This method check the name of the operating system to determine whether their is the word
         * "mac" within the name, and modifies the key accordingly. If this is the case it uses
         * command-option for MacOS and if not it uses Ctrl-Alt for Windows and Linux
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent with the modifiers added 
         ...
         * <p> 
         * A method that returns a keystroke instance that represents a keyboard shortcut with the 
         * Ctrl-shift key on Windows and Linux and the command-shift on MacOS 
         * </p> 
         * 
         * <p> 
         * This method checks the name of the operating system to determine whether their is the word 
         * "mac" within the name, and modifies the key accordingly. If this is the case it uses 
         * command-shift for MacOS and Ctrl-shift for Windows and Linux 
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent with the modifiers added
         ...
         * <p> 
         * A method that returns a keystroke instance that represents a keyboard shortcut with the 
         * Alt-shift key on Windows and Linux and the option-shift key on MacOS
         * </p> 
         * 
         * <p> 
         * This method checks the name of the operating system to determine whether their is the word 
         * "mac" within the name, and modifies the key accordingly. If this is the case it uses the 
         * option-shift for MacOS and if not it uses Alt-shift for Windows and Linux
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent with the modifiers added
         ...
         * 
         * <p>
         * This method assigns a keystroke to the given keyevent with the shift key added
         * </p> 
         * 
         * @param key The keyevent containing the keycode we want to assign 
         * @return A keystroke instance of the given keyevent with the modifies added 
